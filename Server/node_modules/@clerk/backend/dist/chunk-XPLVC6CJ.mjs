...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.2.3"}`;
...
import { isDevelopmentFromSecretKey, isProductionFromSecretKey, parsePublishableKey } from "@clerk/shared/keys";
...
import { parsePublishableKey as parsePublishableKey2 } from "@clerk/shared/keys";
...
var AuthenticateContext = class {
  ...
  initHandshakeValues() {
    this.devBrowserToken = this.clerkRequest.clerkUrl.searchParams.get(constants.QueryParameters.DevBrowser) || this.clerkRequest.cookies.get(constants.Cookies.DevBrowser);
    this.handshakeToken = this.clerkRequest.clerkUrl.searchParams.get(constants.QueryParameters.Handshake) || this.clerkRequest.cookies.get(constants.Cookies.Handshake);
  }
  initHeaderValues() {
...
${error.getFullMessage()}`
  ...
  const pk = parsePublishableKey2(options.publishableKey, {
    fatal: true,
  ...
  async function authenticateRequestWithTokenInCookie() {
    ...
    if (instanceType === "development" && authenticateContext.clerkUrl.searchParams.has(constants.QueryParameters.DevBrowser)) {
...
//# sourceMappingURL=chunk-XPLVC6CJ.mjs.map